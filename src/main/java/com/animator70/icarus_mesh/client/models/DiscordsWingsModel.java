...
public class DiscordsWingsModel<T extends LivingEntity> extends WingEntityModel<T> {
    ...
    public static LayerDefinition getLayerDefinition() {
        ...
        PartDefinition modelPartData11 = modelPartData9.addOrReplaceChild(
                "rightWingStrut01",
                CubeListBuilder.create()
                        .texOffs(83, 12)
        ...
        PartDefinition modelPartData12 = modelPartData9.addOrReplaceChild(
                "rightWingStrut02",
                CubeListBuilder.create()
                        .texOffs(83, 12)
                        .addBox(-0.4F, -0.5F, -0.5F, 1.0F, 1.0F, 16.0F, true),
        ...
        PartDefinition modelPartData13 = modelPartData9.addOrReplaceChild(
                "rightWingStrut03",
                CubeListBuilder.create()
                        .texOffs(83, 12)
                        .addBox(-0.4F, -0.5F, -0.5F, 1.0F, 1.0F, 16.0F, true),
        ...
        modelPartData13.addOrReplaceChild("rightWingStrut03Leather",
                CubeListBuilder.create()
                        .texOffs(93, 19)
                        .addBox(0.15F, 0.0F, 0.0F, 0.0F, 6.0F, 15.0F, true),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition modelPartData14 = modelPartData8.addOrReplaceChild(
                "rightStrutLowest",
                CubeListBuilder.create()
                        .texOffs(104, 12)
